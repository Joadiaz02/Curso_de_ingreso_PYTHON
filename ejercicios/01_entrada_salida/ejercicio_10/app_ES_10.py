...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        numero_1= int(self.txt_importe.get())
        numero_2= int(self.txt_descuento.get())
        descuento = (numero_1*numero_2)/100
        resultado=numero_1-descuento
        resultado_a_texto=str(resultado)
        alert(title="resultado final", message="El importe final es "+resultado_a_texto)
